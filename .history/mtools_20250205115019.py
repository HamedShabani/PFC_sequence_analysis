                        ...
                        for trial_index in range(L_R[side]):
                            ...
                            for condition in data['EvtT']:
                                ...
                                if (side in condition) and (
                                    ...
                                    correxindex, idtr_c = mot.find_correct_index(cond_trials, correct_trials)
                                    falseindex, idtr_f = mot.find_correct_index(cond_trials, false_trials)
