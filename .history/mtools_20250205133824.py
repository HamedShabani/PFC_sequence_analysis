...
def generate_masks(data_all_sessions, session_mask,  ncells):
    ...
    Parameters:
        ...
        evt_data (dict): The event data structure (e.g., data['EvtT']) that provides
                         information such as 'x', 'y', and 'correct_trials'. This is assumed
                         to be common across sessions.
