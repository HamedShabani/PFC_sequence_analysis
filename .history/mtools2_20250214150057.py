...
def binned_burst(dt, winlen, thr_burts, fs, timewins):
    """
    Bin the population data into time windows and detect bursts within each window.
...
def popbursts(mat, sig, fs, kwidth=0, minwidth=1):
    ...
    """
    global Tspare  # Tspare should be defined elsewhere in your code (e.g., burst duration in seconds)
    random_time = False
    import random
...
# Example usage:
# Compute the population rate of the whole session and bursts:
